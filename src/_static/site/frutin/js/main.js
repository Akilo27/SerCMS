!function (e) {
    ...
    if (e(window).on("load", (function () {
        ...
        e(this).scrollTop() > 500 ? (e(".sticky-wrapper").addClass("sticky"), e(".category-menu").addClass("close")) : (e(".sticky-wrapper").removeClass("sticky"), e(".category-menu").removeClass("close"))
    ...
    e("[data-bg-src]").length > 0 && e("[data-bg-src]").each((function () {
        ...
        var t = e(this), a = e(this).data("slider-options"), n = t.find(".slider-prev"), s = t.find(".slider-next"),
            o = t.find(".slider-pagination"), i = a.autoplay, r = {
                slidesPerView: 1,
                ...
                pagination: {
                    el: o.get(0), clickable: !0, renderBullet: function (e, t) {
